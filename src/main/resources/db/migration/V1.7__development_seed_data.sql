...
-- =========================================================
INSERT INTO payment_plan (id, name, description, storage_gb, price, is_active, duration_days, is_popular, display_order, tagline, flashcard_limit, chat_limit, question_limit, summary_limit) VALUES
    (gen_random_uuid(), 'Free',     'Basic plan',   1,      0,      true, -1,  false, 0, NULL,  10,  5,  5,   3),
    (gen_random_uuid(), 'Pro',      'Pro plan',     5,      99000,  true, 30, false, 0, NULL,  50,  20, 20,  100),
